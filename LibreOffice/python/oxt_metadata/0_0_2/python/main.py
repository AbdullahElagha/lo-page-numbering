...
def main(*args):
    ...
    dlg = dp.createDialog("vnd.sun.star.extension://com.addon.pagenumbering/dialogs/PageNumberingDialog.xdl")
...
g_ImplementationHelper.addImplementation(oListenerTop_Class, "com.sun.star.awt.XTopWindowListener", ())
